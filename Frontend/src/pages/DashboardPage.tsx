        ...
        <div className="mb-10 animate-fade-in-up">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
            <div>
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold font-display text-slate-900 mb-2 leading-tight">
                {getGreeting()},{' '}
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-3">
              <button
                ...
                className="group flex items-center gap-2 px-4 sm:px-5 py-2 sm:py-2.5 bg-white/70 backdrop-blur-sm border border-slate-200/50 rounded-xl text-xs sm:text-sm font-medium text-slate-700 hover:bg-white hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300"
              >
              ...
              <button
                onClick={() => navigate('/dashboard/team')}
                className="group flex items-center gap-2 px-4 sm:px-5 py-2 sm:py-2.5 bg-gradient-to-r from-indigo-500 to-violet-500 rounded-xl text-xs sm:text-sm font-medium text-white shadow-lg shadow-indigo-500/25 hover:shadow-xl hover:shadow-indigo-500/30 hover:-translate-y-0.5 transition-all duration-300"
              >

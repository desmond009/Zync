    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 glass border-b border-border/50">
        <div className="container mx-auto px-4 sm:px-6 h-14 sm:h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg sm:text-xl">Zync</span>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <Link to="/login">
              <Button variant="ghost" size="sm" className="h-8 sm:h-9 text-xs sm:text-sm px-2 sm:px-4">Sign in</Button>
            </Link>
            <Link to="/signup">
              <Button size="sm" className="gradient-primary h-8 sm:h-9 text-xs sm:text-sm px-3 sm:px-4">Get started</Button>
            </Link>
          </div>
        </div>
      </header>
      ...
      <section className="pt-24 sm:pt-28 md:pt-32 pb-12 sm:pb-16 md:pb-20 px-4 sm:px-6 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-4xl text-center relative">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight mb-4 sm:mb-6 animate-slide-up leading-tight">
            Work together,{' '}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 animate-slide-up px-4" style={{ animationDelay: '0.2s' }}>
            <Link to="/signup" className="w-full sm:w-auto">
              <Button size="lg" className="w-full sm:w-auto h-11 sm:h-12 px-6 sm:px-8 gradient-primary shadow-glow text-sm sm:text-base">
                Start for free
      ...
      <section id="features" className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 bg-secondary/30">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Everything you need to collaborate</h2>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            {features.map((feature, index) => (
              <div
                key={feature.title}
                className="group p-6 sm:p-8 rounded-2xl bg-card border border-border/50 hover:border-primary/30 hover:shadow-soft transition-all duration-300"
      ...
      {/* Benefits Section */}
      <section id="benefits" className="py-12 sm:py-16 md:py-20 px-4 sm:px-6">
        <div className="container mx-auto max-w-6xl">
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6">
        <div className="container mx-auto max-w-4xl">
          <div className="rounded-2xl sm:rounded-3xl gradient-hero p-8 sm:p-12 md:p-16 text-center relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-white/70 text-sm sm:text-base md:text-lg mb-6 sm:mb-8 max-w-xl mx-auto px-4">
                Join thousands of teams already using Zync to work better together.
              </p>
              <Link to="/signup" className="inline-block">
                <Button size="lg" className="h-11 sm:h-12 px-6 sm:px-8 bg-white text-foreground hover:bg-white/90 text-sm sm:text-base">

...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      {/* Left Side - Branding */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-teal-600 via-cyan-500 to-blue-500 items-center justify-center p-8">
        <div className="text-white space-y-6 max-w-lg">
          <div>
            <h1 className="text-5xl font-bold mb-4 tracking-tight">Zync</h1>
            <p className="text-2xl font-light text-teal-100 mb-8">
              One workspace. Every project. Perfect sync.
            </p>
            <div className="space-y-4 text-teal-100">
              <div className="flex items-start space-x-3">
                <div className="w-6 h-6 rounded-full bg-teal-300/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <div className="w-2 h-2 rounded-full bg-teal-100" />
                </div>
                <p className="text-lg">Start collaborating in minutes</p>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <p className="text-lg">Invite your team and manage projects effortlessly</p>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <p className="text-lg">Free to start, scales with your team</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="rounded-2xl shadow-2xl p-8 md:p-10">
              <div className="mb-8">
                ...
                <p className="text-gray-400">Join thousands of teams using Zync</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  <label htmlFor="workspaceName" className="block text-sm font-medium text-gray-200 mb-2">
                    Workspace Name <span className="text-teal-400 text-xs">(Optional)</span>
                  </label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full pl-11 pr-4 py-3 bg-zinc-900 border border-zinc-700 rounded-lg text-white placeholder-gray-500 
                      focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent
                      transition-all duration-200"
                      placeholder="My Awesome Team"
                    />
                  </div>
                  <p className="mt-1 text-xs text-gray-500">You can always create or join workspaces later</p>
                </div>
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full py-3 px-4 bg-teal-600 text-white font-semibold rounded-lg
                  hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 
                  focus:ring-teal-500 focus:ring-offset-zinc-950
